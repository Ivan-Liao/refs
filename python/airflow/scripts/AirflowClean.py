...
def cleanScooter():
    ...
    df.to_csv('~/data/cleanscooter.csv')


def filterData():
    df=pd.read_csv('~/data/cleanscooter.csv')
    fromd = '2019-05-23'
    tod='2019-06-03'
    tofrom = df[(df['started_at']>fromd)&(df['started_at']<tod)]
    tofrom.to_csv('~/data/may23-june3.csv')	
...
with DAG('CleanData',
    ...
    moveFile = BashOperator(task_id='move',
                                 bash_command='mv /home/ivanli/data/may23-june3.csv /home/ivanli/Desktop')
