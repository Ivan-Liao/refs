"""
Documentation
Description: Fail with incorrect bash command in ssh operator. 
...
# ssh operator task
ssh_hook_local = SSHHook(
    remote_host="192.168.0.134",
    username="Festi",
    password="Gatesmicroilluminati1058",
    port=22
)
